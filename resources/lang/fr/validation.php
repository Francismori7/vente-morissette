...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'parents.*.gender' => [
            'required' => 'La relation du parent est requise.',
        ],
        'old_password' => [
            'auth' => 'Votre mot de passe actuel est incorrect.',
            'required_unless' => 'Le champ :attribute est obligatoire si :other n\'est pas vide.',
        ],
        'password' => [
            'required_unless' => 'Le champ :attribute est obligatoire si :other n\'est pas vide.',
        ],
